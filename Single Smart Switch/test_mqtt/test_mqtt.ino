...
//---- WiFi settings
const char* ssid = “Falia”;
const char* password = “innocentia”;
//---- MQTT Broker settings
const char* mqtt_server = “05a75a25f8df4d9c83361daae0887199.s2.eu.hivemq.cloud”; // replace with your broker url
